  ...
  <div class="max-w-3xl">
    <div class="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
      <div class="px-6 py-4 border-b border-slate-200">
        <h1 class="text-lg font-semibold">Klant bewerken</h1>
        <p class="text-sm text-slate-500">Vul de gegevens in en sla op.</p>
      </div>

      <form method="post" action="<?php echo ADMIN_BASE_PATH; ?>/customers/<?php echo (int)$customer['id']; ?>/update" class="p-6 space-y-4">
        ...
        <div>
          ...
          <input class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-900/10"
                 type="text" name="name" value="<?php echo htmlspecialchars((string)($customer['name'] ?? ''), ENT_QUOTES); ?>" required>
        </div>

        <div>
          <label class="block text-sm font-medium text-slate-700 mb-1">E-mail</label>
          <input class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-900/10"
                 type="email" name="email" value="<?php echo htmlspecialchars((string)($customer['email'] ?? ''), ENT_QUOTES); ?>">
        </div>

        <div>
          <label class="block text-sm font-medium text-slate-700 mb-1">Telefoon</label>
          <input class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-900/10"
                 type="text" name="phone" value="<?php echo htmlspecialchars((string)($customer['phone'] ?? ''), ENT_QUOTES); ?>">
        </div>

        <div>
          <label class="block text-sm font-medium text-slate-700 mb-1">Bedrijf</label>
          <input class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-900/10"
                 type="text" name="company" value="<?php echo htmlspecialchars((string)($customer['company'] ?? ''), ENT_QUOTES); ?>">
        </div>

        <div>
          <label class="block text-sm font-medium text-slate-700 mb-1">BTW nummer</label>
          <input class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-900/10"
                 type="text" name="vat" value="<?php echo htmlspecialchars((string)($customer['vat'] ?? ''), ENT_QUOTES); ?>">
        </div>
        ...
        <div>
          ...
          <input class="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm outline-none focus:ring-2 focus:ring-slate-900/10"
                 ...
                 value="<?php echo htmlspecialchars((string)($customer['address'] ?? ''), ENT_QUOTES); ?>">
        </div>
